...
namespace Flee.Parsing
{
    internal class FleeExpressionAnalyzer : ExpressionAnalyzer
    {
        ...
        {
            _myUnicodeEscapeRegex = new Regex("\\\\u[0-9a-f]{4}", RegexOptions.IgnoreCase | RegexOptions.Compiled);
            _myRegularEscapeRegex = new Regex("\\\\[\\\\\"'trn]", RegexOptions.IgnoreCase | RegexOptions.Compiled);
        }
